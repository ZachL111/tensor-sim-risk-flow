...
`tensor-sim-risk-flow` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for risk workflows, centered on policy evaluation, deny and allow fixtures, and explainable decision traces.
...
The score is deterministic. The current threshold is 175. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 3.
