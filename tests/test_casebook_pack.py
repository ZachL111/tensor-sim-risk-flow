"""Regression checks for the tensor-sim-risk-flow casebook."""
...
from casebook.harness import assert_expected, tensor_sim_risk_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_sim_risk_flow_summary(), assert_expected())
